...
Partial Class Inventory_Administration_frmOrderEntry
    ...
    Protected Sub grdOrderList_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles grdOrderList.SelectedIndexChanged
        Dim lblOrderID, lblBuyerID, lblStyleID, lblOrderQuantity, lblOrderDate, lblDeliveryDate, lblOrderDetails As Label
        Try
