<%@ Page Language="VB" Theme="CommonSkin" MasterPageFile="~/Inventory/AIMaster.master"
    AutoEventWireup="false" CodeFile="frmProcurement.aspx.vb" Inherits="frmProcurement"
    Title=".:Valmont Sweaters:Procurement Info:." %>
        ...
        <tr align="center">
            <td>
                <asp:Panel ID="pnlProcurementDetails" runat="server" Width="100%" SkinID="pnlInner">
                    <div>
                        <asp:GridView ID="grdInvoiceItems" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                            CssClass="mGrid">
                            <Columns>
                                <asp:TemplateField HeaderText="Sl">
                                    <ItemTemplate>
