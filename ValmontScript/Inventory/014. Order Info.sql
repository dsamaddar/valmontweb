...
OrderNumber nvarchar(50) Unique(OrderNumber),
OrderQuantity int,
OrderDate date,
DeliveryDate date,
...
as
begin
	Select OrderID,O.BuyerID,B.BuyerName as 'Buyer',O.StyleID,S.Style,OrderNumber,OrderQuantity,
...
Create proc spGetOrderInfoByBuyerID
@BuyerID nvarchar(50)
as
begin
	Select OrderID,O.BuyerID,B.BuyerName as 'Buyer',O.StyleID,S.Style,OrderNumber,OrderQuantity,
...
-- exec spGetOrderInfoByBuyerID 'B-00000012'
...
begin tran
	...
	Insert Into tblOrder(OrderID,BuyerID,StyleID,OrderNumber,OrderQuantity,OrderDate,DeliveryDate,OrderDetails,EntryBy)
	Values(@OrderID,@BuyerID,@StyleID,@OrderNumber,@OrderQuantity,@OrderDate,@DeliveryDate,@OrderDetails,@EntryBy)
	IF (@@ERROR <> 0) GOTO ERR_HANDLER
...
as
begin
	update tblOrder Set BuyerID=@BuyerID,StyleID=@StyleID,OrderNumber=@OrderNumber,OrderQuantity=@OrderQuantity,OrderDate=@OrderDate,
